...
var Module = typeof jqModule != 'undefined' ? jqModule : {};
...
// end include: node_shell_read.js
  ...
  if (typeof WebAssembly == 'undefined') {
    requireNodeFS();
    eval(fs.readFileSync(locateFile('jq.wasm.js'))+'');
  }
...
if (ENVIRONMENT_IS_SHELL) {
  ...
  // If target shell does not support Wasm, load the JS version of the code.
  if (typeof WebAssembly == 'undefined') {
    eval(read(locateFile('jq.wasm.js'))+'');
  }
...
if (Module['locateFile']) {
  ...
  wasmBinaryFile = new URL('jq.wasm', import.meta.url).toString();
}
